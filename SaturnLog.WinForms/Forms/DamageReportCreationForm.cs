...
{
    public partial class DamageReportCreationForm : Form
    {
        #region Event Handlers
        private void DamageReportCreationForm_Shown(object sender, EventArgs e)
        {
            // Unsubscribe from shown event.
            this.Load -= DamageReportCreationForm_Shown;
        ...
        // Instance of Saturn5 unit used by the form to create damage report for.
        private Saturn5 _saturn5;

        // User responsible for the damage.
        private User _user;
        ...
        #region Constructor
        // Default constructor
        public DamageReportCreationForm(App app, Saturn5 saturn5)
        {
            ...
            this.Shown += DamageReportCreationForm_Shown;
        }
        #endregion
