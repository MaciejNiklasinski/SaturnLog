...
{
    #region Old
    //public partial class UserWithSaturn5SerialNumberValidatingTextBox : TextBox // InputValidatingTextBox<UserWithSaturn5SerialNumberEventArgs, User>
    //{
    //    #region Events
    ...
    //    public event EventHandler<UserWithSaturn5SerialNumberEventArgs> EmptyInputValueProvided;

    //    // Event which getting invoked every time when user provided invalid input and pressed enter key.
    //    public event EventHandler<UserWithSaturn5SerialNumberEventArgs> InvalidInputValueProvided;

    //    // Event which getting invoked every time when user provided valid input and pressed enter key.
    //    public event EventHandler<UserWithSaturn5SerialNumberEventArgs> ValidInputValueProvided;
    //    #endregion
    ...
    //    //
    //    Func<User, string, UserWithSaturn5SerialNumberEventArgs> _inputProvidedEArgsCreationFunc;
    ...
    //    public Func<User, string, UserWithSaturn5SerialNumberEventArgs> InputProvidedEArgsCreationFunc
    //    {
    ...
    //    #region Constructors
    //    public UserWithSaturn5SerialNumberValidatingTextBox()
    //    {
    ...
    public partial class UserWithSaturn5SerialNumberValidatingTextBox : ExtendedInputValidatingTextBox<UserWithSaturn5SerialNumberEventArgs, User>
    {
        public UserWithSaturn5SerialNumberValidatingTextBox()
        {
            InitializeComponent();
