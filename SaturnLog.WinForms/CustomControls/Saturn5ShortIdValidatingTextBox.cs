...
{
    #region Old
    //public partial class Saturn5ShortIdValidatingTextBox : TextBox
    //{
    //    #region Events
    ...
    //    public event EventHandler<Saturn5ShortIdEventArgs> EmptyInputValueProvided;

    //    // Event which getting invoked every time when user provided invalid input and pressed enter key.
    //    public event EventHandler<Saturn5ShortIdEventArgs> InvalidInputValueProvided;

    //    // Event which getting invoked every time when user provided valid input and pressed enter key.
    //    public event EventHandler<Saturn5ShortIdEventArgs> ValidInputValueProvided;
    //    #endregion
    ...
    //    //
    //    Func<string, Saturn5ShortIdEventArgs> _inputProvidedEArgsCreationFunc;
    //    #endregion
    ...
    //    public Func<string, Saturn5ShortIdEventArgs> InputProvidedEArgsCreationFunc
    //    {
    ...
    //    #region Constructors
    //    public Saturn5ShortIdValidatingTextBox()
    //    {
    ...
    public partial class Saturn5ShortIdValidatingTextBox : InputValidatingTextBox<Saturn5ShortIdEventArgs>
    {
        public Saturn5ShortIdValidatingTextBox()
        {
            InitializeComponent();
