...
{
    #region Old
    //public partial class UserUsernameValidatingTextBox : TextBox
    //{
    //    #region Events
    ...
    //    public event EventHandler<UserUsernameEventArgs> EmptyInputValueProvided;

    //    // Event which getting invoked every time when user provided invalid input and pressed enter key.
    //    public event EventHandler<UserUsernameEventArgs> InvalidInputValueProvided;

    //    // Event which getting invoked every time when user provided valid input and pressed enter key.
    //    public event EventHandler<UserUsernameEventArgs> ValidInputValueProvided;
    //    #endregion
    ...
    //    //
    //    Func<string, UserUsernameEventArgs> _inputProvidedEArgsCreationFunc;
    //    #endregion
    ...
    //    public Func<string, UserUsernameEventArgs> InputProvidedEArgsCreationFunc
    //    {
    ...
    //    #region Constructors
    //    public UserUsernameValidatingTextBox()
    //    {
    ...
    public partial class UserUsernameValidatingTextBox : InputValidatingTextBox<UserUsernameEventArgs>
    {
        public UserUsernameValidatingTextBox()
        {
            InitializeComponent();
