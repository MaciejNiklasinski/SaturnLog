...
namespace SaturnLog.UI
{
    ...
    //                this.EmptyInputValueProvided?.Invoke(sender, this._inputProvidedEArgsCreationFunc.Invoke(""));
    //            }
    ...
    //                this.InvalidInputValueProvided?.Invoke(sender, this._inputProvidedEArgsCreationFunc.Invoke(this.Text));
    //            }
    ...
    //                this.ValidInputValueProvided?.Invoke(sender, this._inputProvidedEArgsCreationFunc.Invoke(this.Text));
    //            }
    //        }
    ...
    //    //
    //    Func<string, EventArgs> _inputProvidedEArgsCreationFunc;
    //    #endregion
    ...
    //    public Func<string, EventArgs> InputProvidedEArgsCreationFunc
    //    {
    ...
    public partial class InputValidatingTextBox<EArgs> : TextBox where EArgs : EventArgs
    {
        #region Events
        // Occurs every time when the current text box getting enabled for user input.
        public event EventHandler InputEnabled;
        ...
        private void InputValidatingTextBox_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter || e.KeyCode == Keys.Return)
            {
                ...
                if (!this.AllowEmptyInput && this.IsConsideredEmpty())
                {
                    ...
                    args = this._inputProvidedEArgsCreationFunc.Invoke("");
                ...
                args = this._inputProvidedEArgsCreationFunc.Invoke(this.Text);
                ...
                validatingTask.ContinueWith((t) =>
                {
                    ...
                    switch (t.Status)
                    {
                        case TaskStatus.RanToCompletion:
                            ...
                            {
                                // Invoke methods provided to be invoked when invalid input have been provided.
                                this.InvalidInputValueProvided?.Invoke(sender, args);
                            ...
                            else
                            {
                                ...
                                // Invoke methods provided to be invoked when valid input have been provided.
                                this.ValidInputValueProvided?.Invoke(sender, args);
                            }
                            break;
            ...
            // If other key then 'enter' have been pressed.
            else if (this._watermarkMode || this._watermarkErrorMode)
            {
                this._watermarkMode = false;
                this._watermarkErrorMode = false;
        ...
        Func<string, EArgs> _inputProvidedEArgsCreationFunc;
        #endregion
        ...
        public Func<string, EArgs> InputProvidedEArgsCreationFunc
        {
            get { return this._inputProvidedEArgsCreationFunc; }
            set { this._inputProvidedEArgsCreationFunc = value; }
        }
