...
{
    #region Old
    //public partial class Saturn5SerialNumberValidatingTextBox : TextBox // InputValidatingTextBox<UserWithSaturn5SerialNumberEventArgs, User>
    //{
    //    #region Events
    ...
    //    public event EventHandler<Saturn5SerialNumberEventArgs> EmptyInputValueProvided;

    //    // Event which getting invoked every time when user provided invalid input and pressed enter key.
    //    public event EventHandler<Saturn5SerialNumberEventArgs> InvalidInputValueProvided;

    //    // Event which getting invoked every time when user provided valid input and pressed enter key.
    //    public event EventHandler<Saturn5SerialNumberEventArgs> ValidInputValueProvided;
    //    #endregion
    ...
    //    //
    //    Func<string, Saturn5SerialNumberEventArgs> _inputProvidedEArgsCreationFunc;
    //    #endregion
    ...
    //    public Func<string, Saturn5SerialNumberEventArgs> InputProvidedEArgsCreationFunc
    //    {
    ...
    //    #region Constructors
    //    public Saturn5SerialNumberValidatingTextBox()
    //    {
    ...
    public partial class Saturn5SerialNumberValidatingTextBox : InputValidatingTextBox<Saturn5SerialNumberEventArgs>
    {
        public Saturn5SerialNumberValidatingTextBox()
        {
            InitializeComponent();
