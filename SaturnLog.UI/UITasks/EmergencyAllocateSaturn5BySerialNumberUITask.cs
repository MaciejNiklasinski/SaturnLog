...
namespace SaturnLog.UI
{
    ...
    {
        // Emergency Allocates Saturn5 unit to the specified user.
        public class EmergencyAllocateSaturn5BySerialNumberUITask : IUITask<EventArgs>
        {
            #region Events
            ...
            #region Constructor
            // Default constructor.
            public EmergencyAllocateSaturn5BySerialNumberUITask(MainForm form)
            {
                this._form = form;
            }
            #endregion
            ...
            #region EmergencyAllocateSaturn5BySerialNumberUITask Operation EventHandlers - Operation Logic
            ...
            private void OnAwaitingUsername(object sender, System.EventArgs e)
            {
                ...
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_AwaitingUsername(sender, e);
                ...
                this._controlsEnabler.OnEmergencyAllocateSaturn5BySerialNumber_AwaitingUsername(sender, e);
            }
            ...
            private void OnAwaitingUsernameCanceled(object sender, System.EventArgs e)
            {
                ...
                this._controlsEnabler.OnEmergencyAllocateSaturn5BySerialNumber_AwaitingUsernameCanceled(sender, e);

                // Displays appropriate logs informing user that application canceled obtaining user data.
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_AwaitingUsernameCanceled(sender, e);
            ...
            private void OnProvidedUsernameValidationBegan(object sender, UserUsernameEventArgs e)
            {
                ...
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_ProvidedUsernameValidationBegan(sender, e);
            }
            ...
            {
                // Displays appropriate logs informing user about empty username input being provided.
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_ProvidedUsernameValidationFailed(sender, e);
            ...
            private void OnProvidedUsernameValidationCanceled(object sender, UserUsernameEventArgs e)
            {
                ...
                // Enables/Disables appropriate controls.
                this._controlsEnabler.OnEmergencyAllocateSaturn5BySerialNumber_ProvidedUsernameValidationCanceled(sender, e);

                // Displays appropriate logs informing
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_ProvidedUsernameValidationCanceled(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);
            ...
            private void OnValidUsernameProvided(object sender, UserUsernameEventArgs e)
            {
                ...
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_ValidUsernameProvided(sender, e);

                // Disables user username input text box
                this._controlsEnabler.OnEmergencyAllocateSaturn5BySerialNumber_ValidUsernameProvided(sender, e);
            ...
            {
                // Displays appropriate logs/application state/user instructions text to the user.
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_AwaitingSerialNumber(sender, e);
                ...
                this._controlsEnabler.OnEmergencyAllocateSaturn5BySerialNumber_AwaitingSerialNumber(sender, e);
            }
            ...
            private void OnAwaitingSerialNumberCanceled(object sender, System.EventArgs e)
            {
                ...
                // Enables/Disables appropriate controls.
                this._controlsEnabler.OnEmergencyAllocateSaturn5BySerialNumber_AwaitingSerialNumberCanceled(sender, e);

                // Displays appropriate logs informing user that application canceled obtaining user data.
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_AwaitingSerialNumberCanceled(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);
            ...
            {
                // Displays appropriate logs informing user about empty serial number input being provided.
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_EmptySerialNumberProvided(sender, e);
            }
            ...
            // Occurs whenever saturn 5 emergency allocation completed successfully.
            private void OnSucceed(object sender, UserWithSaturn5EventArgs e)
            {
                // Informs user about success of the saturn 5 emergency allocation
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_Succeed(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);

                // Enable appropriate controls.
                this._controlsEnabler.OnEmergencyAllocateSaturn5BySerialNumber_Succeed(sender, e);
            }

            // Occurs whenever saturn 5 emergency allocation failed from some other reason then unit being faulty or damaged.
            private void OnFailed(object sender, UserWithSaturn5EventArgs e)
            {
                // Print operation failure logs.
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_Failed(sender, e);

                // Ask user what to do in case of failure
                DialogResult result = MessageBox.Show($"Failed to emergency allocate Saturn 5. Would You like to retry? Or would you like to cancel and close the application.", "Failed to emergency allocate Saturn 5.", MessageBoxButtons.RetryCancel);
            ...
            // Occures whenever saturn 5 emergency allocation process has been canceled.
            private void OnCanceled(object sender, UserWithSaturn5EventArgs e)
            {
                // Displays appropriate logs informing user that application canceled obtaining user data.
                this._consolesServices.OnEmergencyAllocateSaturn5BySerialNumber_Canceled(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);
                ...
                // Enable appropriate controls.
                this._controlsEnabler.OnEmergencyAllocateSaturn5BySerialNumber_Canceled(sender, e);
            }
            #endregion
