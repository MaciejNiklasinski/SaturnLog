...
namespace SaturnLog.UI
{
    ...
    {
        // Confirms faulty Saturn 5 unit back in depot using its serial number
        public class ConfirmBackInFaultySaturn5BySerialNumberUITask : IUITask<EventArgs>
        {
            #region Events
            ...
            #region Constructor
            // Default constructor. 
            public ConfirmBackInFaultySaturn5BySerialNumberUITask(MainForm form)
            {
                this._form = form;
            }
            #endregion
            ...
            #region ConfirmBackInFaultySaturn5BySerialNumber Operation EventHandlers - Operation Logic
            ...
            private void OnAwaitingSerialNumber(object sender, System.EventArgs e)
            {
                ...
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_AwaitingSerialNumber(sender, e);
                ...
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_AwaitingSerialNumber(sender, e);
            }
            ...
            private void OnAwaitingSerialNumberCanceled(object sender, System.EventArgs e)
            {
                ...
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_AwaitingSerialNumberCanceled(sender, e);

                // Displays appropriate logs informing user that application canceled obtaining user data.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_AwaitingSerialNumberCanceled(sender, e);
            ...
            private void OnProvidedSerialNumberValidationBegan(object sender, Saturn5SerialNumberEventArgs e)
            {
                ...
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_ProvidedSerialNumberValidationBegan(sender, e);
            }
            ...
            {
                // Displays appropriate logs informing user about empty serial number input being provided.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_ProvidedSerialNumberValidationFailed(sender, e);
            ...
            private void OnProvidedSerialNumberValidationCanceled(object sender, Saturn5SerialNumberEventArgs e)
            {
                ...
                // Enables/Disables appropriate controls.
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_ProvidedSerialNumberValidationCanceled(sender, e);

                // Displays appropriate logs informing user about empty serial number input being provided.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_ProvidedSerialNumberValidationCanceled(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);
            ...
            {
                // Displays appropriate logs informing user about empty serial number input being provided.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_EmptySerialNumberProvided(sender, e);
            }
            ...
            private void OnInvalidSerialNumberProvided(object sender, Saturn5SerialNumberEventArgs e)
            {
                ...
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_InvalidSerialNumberProvided(sender, e);
            }
            ...
            private void OnValidSerialNumberProvided(object sender, Saturn5SerialNumberEventArgs e)
            {
                ...
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_ValidSerialNumberProvided(sender, e);

                // Disables saturn 5 serial number input text box
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_ValidSerialNumberProvided(sender, e);
            ...
            private void OnCancelToRetrieveSaturn5Data(object sender, Saturn5SerialNumberEventArgs e)
            {
                ...
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_CancelToRetrieveSaturn5Data(sender, e);
            }
            ...
            private void OnCancelToEmergencyAllocateSaturn5BySerialNumber(object sender, UserUsernameWithSaturn5 e)
            {
                ...
                // Enable appropriate controls.
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_CancelToRetrieveUserData(sender, e);
            }
            ...
            private void OnReportDataUploadRequired(object sender, UserWithSaturn5FaultReportEventArgs e)
            {
                // Displays appropriate logs informing user that application began uploading the saturn 5 confirmation data.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_UploadingSaturn5ReportingFaultDataBegan(sender, e);
                
                // Report the fault based on the FaultReportCreationForm
                Task reportingFaultTask = this._saturn5Services.ReportFaultAsync(e.Saturn5.SerialNumber, e.User.Username, e.Description);
                reportingFaultTask.ContinueWith((t) =>
                {
                    switch (t.Status)
                    {
                        case TaskStatus.RanToCompletion:
                            ...
                            this.OnUploadingSaturn5ReportingFaultDataSucceed(sender, new UserWithFaultySaturn5EventArgs(e.User, e.Saturn5, fault));
                            break;
            ...
            // Occurs whenever attempt to commit fault data upload failed
            private void OnUploadingSaturn5ReportingFaultDataFailed(object sender, UserWithSaturn5FaultReportEventArgs e)
            {
                // Print operation failure logs.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_UploadingSaturn5ReportingFaultDataFailed(sender, e);

                // Ask user what to do in case of failure
                DialogResult result = MessageBox.Show($"Failed to report Saturn 5 unit fault. Would You like to retry? Or would you like to cancel and close the application.", "Failed to report Saturn 5 unit fault.", MessageBoxButtons.RetryCancel);
            ...
            // Occurs whenever attempt to commit fault data upload has been canceled
            private void OnUploadingSaturn5ReportingFaultDataCanceled(object sender, UserWithSaturn5FaultReportEventArgs e)
            {
                // Displays appropriate logs informing user that application canceled obtaining user data.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_UploadingSaturn5ReportingFaultDataCanceled(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);
                ...
                // Enables/Disables appropriate controls.
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_UploadingSaturn5ReportingFaultDataCanceled(sender, e);
            }

            // Occurs whenever attempt to commit fault data upload has been completed successfully
            private void OnUploadingSaturn5ReportingFaultDataSucceed(object sender, UserWithFaultySaturn5EventArgs e)
            {
                // Displays appropriate logs informing user about valid serial number being provided.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_UploadingSaturn5ReportingFaultDataSucceed(sender, e);

                // Disables saturn 5 serial number input text box
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_UploadingSaturn5ReportingFaultDataSucceed(sender, e);
            ...
            private void OnDataUploadRequired(object sender, UserWithFaultySaturn5EventArgs e)
            {                
                // Displays appropriate logs informing user that application began uploading the saturn 5 confirmation data.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_UploadingSaturn5ConfirmationDataBegan(sender, e);
            ...
            private void OnAttemptToConfirmStarUserSaturn5(object sender, UserWithFaultySaturn5EventArgs e)
            {
                // Ask user what to do 
            ...
            private void OnSucceed(object sender, UserWithFaultySaturn5EventArgs e)
            {
                // Informs user about success of the saturn 5 confirmation
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_Succeed(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);

                // Enable appropriate controls.
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_Succeed(sender, e);
            }

            // Occurs whenever saturn 5 confirmation failed.
            private void OnFailed(object sender, UserWithFaultySaturn5EventArgs e)
            {
                // Print operation failure logs.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_Failed(sender, e);

                // Ask user what to do in case of failure
                DialogResult result = MessageBox.Show($"Failed to confirm back in faulty Saturn 5 unit. Would You like to retry? Or would you like to cancel and close the application.", "Failed to faulty confirm back in Saturn 5 unit.", MessageBoxButtons.RetryCancel);
                if (result == DialogResult.Retry)
                {
                    // If user pressed 'Retry' button, reattempt to connect with database. 
                    this.OnDataUploadRequired(sender, e);
            ...
            private void OnCanceled(object sender, UserWithFaultySaturn5EventArgs e)
            {
                // Print appropriate logs.
                this._consolesServices.OnConfirmBackInFaultySaturn5BySerialNumber_Canceled(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);
                ...
                // Enable appropriate controls.
                this._controlsEnabler.OnConfirmBackInFaultySaturn5BySerialNumber_Canceled(sender, e);
            }
            #endregion
