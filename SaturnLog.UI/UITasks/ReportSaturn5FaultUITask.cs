...
namespace SaturnLog.UI
{
    ...
    {
        // Report Saturn 5 unit fault
        public class ReportSaturn5FaultUITask : IUITask<EventArgs>
        {
            #region Events
            ...
            #region Constructor
            // Default constructor. 
            public ReportSaturn5FaultUITask(MainForm form)
            {
                this._form = form;
            }
            #endregion
            ...
            #region ReportSaturn5Fault Operation EventHandlers - Operation Logic
            ...
            private void OnAwaitingSerialNumber(object sender, System.EventArgs e)
            {
                ...
                this._consolesServices.OnReportSaturn5Fault_AwaitingSerialNumber(sender, e);
                ...
                this._controlsEnabler.OnReportSaturn5Fault_AwaitingSerialNumber(sender, e);
            }
            ...
            private void OnAwaitingSerialNumberCanceled(object sender, System.EventArgs e)
            {
                ...
                this._controlsEnabler.OnReportSaturn5Fault_AwaitingSerialNumberCanceled(sender, e);

                // Displays appropriate logs informing user that application canceled obtaining user data.
                this._consolesServices.OnReportSaturn5Fault_AwaitingSerialNumberCanceled(sender, e);
            ...
            private void OnProvidedSerialNumberValidationBegan(object sender, Saturn5SerialNumberEventArgs e)
            {
                ...
                this._consolesServices.OnReportSaturn5Fault_ProvidedSerialNumberValidationBegan(sender, e);
            }
            ...
            {
                // Displays appropriate logs informing user about empty serial number input being provided.
                this._consolesServices.OnReportSaturn5Fault_ProvidedSerialNumberValidationFailed(sender, e);
            ...
            private void OnProvidedSerialNumberValidationCanceled(object sender, Saturn5SerialNumberEventArgs e)
            {
                ...
                // Enables/Disables appropriate controls.
                this._controlsEnabler.OnReportSaturn5Fault_ProvidedSerialNumberValidationCanceled(sender, e);

                // Displays appropriate logs informing user about empty serial number input being provided.
                this._consolesServices.OnReportSaturn5Fault_ProvidedSerialNumberValidationCanceled(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);
            ...
            {
                // Displays appropriate logs informing user about empty serial number input being provided.
                this._consolesServices.OnReportSaturn5Fault_EmptySerialNumberProvided(sender, e);
            }
            ...
            private void OnInvalidSerialNumberProvided(object sender, Saturn5SerialNumberEventArgs e)
            {
                ...
                this._consolesServices.OnReportSaturn5Fault_InvalidSerialNumberProvided(sender, e);
            }
            ...
            private void OnValidSerialNumberProvided(object sender, Saturn5SerialNumberEventArgs e)
            {
                ...
                this._consolesServices.OnReportSaturn5Fault_ValidSerialNumberProvided(sender, e);

                // Disables saturn 5 serial number input text box
                this._controlsEnabler.OnReportSaturn5Fault_ValidSerialNumberProvided(sender, e);
            ...
            private void OnUploadingSaturn5ReportingFaultDataFailed(object sender, Saturn5FaultReportEventArgs e)
            {
                // Print operation failure logs.
                this._consolesServices.OnReportSaturn5Fault_Failed(sender, e);
            ...
            private void OnUploadingSaturn5ReportingFaultDataCanceled(object sender, Saturn5FaultReportEventArgs e)
            {
                // Displays appropriate logs informing user that application canceled obtaining user data.
                this._consolesServices.OnReportSaturn5Fault_Canceled(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);
                ...
                // Enables/Disables appropriate controls.
                this._controlsEnabler.OnReportSaturn5Fault_Canceled(sender, e);
            }

            // Occurs whenever attempt to commit fault data upload has been completed successfully
            private void OnUploadingSaturn5ReportingFaultDataSucceed(object sender, FaultySaturn5EventArgs e)
            {
                // Displays appropriate logs informing user about valid serial number being provided.
                this._consolesServices.OnReportSaturn5Fault_Succeed(sender, e);
                this._consolesServices.OnBackToIdle(sender, e);

                // Disables saturn 5 serial number input text box
                this._controlsEnabler.OnReportSaturn5Fault_Succeed(sender, e);
            }
            #endregion
