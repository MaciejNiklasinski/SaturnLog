...
{
    [Serializable]
    public class AttemptToConfirmStarUserSaturn5Exception : Exception
    {
        public const string DefaultMessage = "Unable to confirm back in depot saturn 5 unit owned by star user.";
        ...
        public AttemptToConfirmStarUserSaturn5Exception(User user, Saturn5 saturn5, string message) : base(message)
        {
            this.User = user;
            this.Saturn5 = saturn5;
        }
        ...
        protected AttemptToConfirmStarUserSaturn5Exception(System.Runtime.Serialization.SerializationInfo info,
