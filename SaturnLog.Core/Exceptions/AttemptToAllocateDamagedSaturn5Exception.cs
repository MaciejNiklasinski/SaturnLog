...
{
    [Serializable]
    public class AttemptToAllocateDamagedSaturn5Exception : Exception
    {
        public const string DefaultMessage = "Unable to allocate damaged saturn 5 unit.";
        ...
        public AttemptToAllocateDamagedSaturn5Exception(User user, Saturn5 saturn5, string message) : base(message)
        {
            this.User = user;
            this.Saturn5 = saturn5;
        }
